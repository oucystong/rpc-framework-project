 ...
 * @Author: Mr.Tong
 */
public class RMIPerformanceTest {
    ...
    public static void main(String[] args) {
        ...
        ConcurrencyTester tester0 = ThreadUtil.concurrencyTest(1, () -> {
            ...
            for (Integer i = 0; i < 100000; i++) {
                try {
                    StrService strService = (StrService) Naming.lookup("rmi://localhost:2000/str");
                    String requestString = strService.getRequestString(fixedLengthStr);
//                    System.out.println(Thread.currentThread().getName() + "客户端执行: 第" + i + "次请求");
                } catch (Exception e) {
