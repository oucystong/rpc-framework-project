...
//        setListenterThreeThree(client);
    ...
    void testA() throws Exception {
        ExponentialBackoffRetry exponentialBackoffRetry = new ExponentialBackoffRetry(6000, 2);

        CuratorFramework curatorFramework = CuratorFrameworkFactory.builder().retryPolicy(exponentialBackoffRetry).connectString("127.0.0.1:2181").build();
